...
- 新增环境变量：
  ...
  - `SATELLITE_REMOTE_SENSING_FUSION_DIRECT_ENABLED=false`
...
- 说明：
  ...
  - `SATELLITE_REMOTE_SENSING_FUSION_DIRECT_ENABLED` 控制是否启用阶段8直出融合结果并在阶段9跳过 `fusion_stack_envi.py`（默认 `false`）
