...
> **用途**：阶段收口或集群里程碑后，将当时状态快照写入 `docs/archives/`，保留可审计历史。  
> **原则**：活跃 Runbook 保留摘要与链接；完整数据、表格、日志摘要进归档。现网行为以 `SYSTEM_OVERVIEW.md`、CLUSTER120 文档与 `decisions/` 为准。
...
| 2026-06-18 | [2026-06-18_phase1-closure.md](./2026-06-18_phase1-closure.md) | Phase 1 Redis 入队 + rs-worker 收口；task 140 全链路 ~28.3 min | [PHASE1_RUNBOOK.md](../PHASE1_RUNBOOK.md) |
| 2026-06-18 | [2026-06-18_phase2-closure.md](./2026-06-18_phase2-closure.md) | Phase 2 od-worker 独立检测；task 141；rs→od 双队列 | [PHASE2_RUNBOOK.md](../PHASE2_RUNBOOK.md) |
...
| 2026-07-20 | [2026-07-20_p5-60node-closure.md](./2026-07-20_p5-60node-closure.md) | **P5 60 节点正式收口**；p5-60-retry-20260720-0942 **3/3**；断言通过 | [CLUSTER120_SAT10_STEPS.md](../CLUSTER120_SAT10_STEPS.md) 阶段 G |
| 2026-07-23 | [2026-07-23_post-p5-60node-closure.md](./2026-07-23_post-p5-60node-closure.md) | **Post-P5 主线收口**；D0 MinIO + 本星队列 + 强制选卫星 | [D0_MINIO_ARTIFACT_UPLOAD_60.md](../D0_MINIO_ARTIFACT_UPLOAD_60.md) |
| 2026-07-24 | [../decisions/2026-07-24_od-worker-60node.md](../decisions/2026-07-24_od-worker-60node.md) | **N4 冻结**：OD in-process；od-worker=0 | 本决策文 |
