...
> **最后更新**：2026-06-23（Phase 3 归档；**Phase 4 规划启动**，无 GPU）
...
| **Phase 3 Argo DAG** | [PHASE3_RUNBOOK.md](./PHASE3_RUNBOOK.md) | **已归档**；[archives/2026-06-23_phase3-performance-closure.md](./archives/2026-06-23_phase3-performance-closure.md) |
| **Phase 4 可观测 / 多 task** | [PHASE4_RUNBOOK.md](./PHASE4_RUNBOOK.md) | **规划中**；无 GPU |
...
| Phase 2 od-worker | `PHASE2_RUNBOOK.md`、`archives/2026-06-18_phase2-closure.md`、`archives/2026-06-22_phase2-production-validation.md`、`k8s/phase2/` |
| Phase 3 Argo | `PHASE3_RUNBOOK.md`、`k8s/phase3/argo/INSTALL_CHECKLIST.md`（已归档） |
| Phase 4 规划 | `PHASE4_RUNBOOK.md` |
